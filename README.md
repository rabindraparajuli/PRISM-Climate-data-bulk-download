**PRISM Gridded time series datasets bulk download for CONSUS**

PRISM (Parameter-elevation Regressions on Independent Slopes Model) Climate data are no longer available for manual bulk download, particularly the daily raster products for the newer 800 m resolution datasets. Because I needed to download large volumes of daily data across multiple years and date ranges, following their instructions I put together a Python workflow in a Jupyter Notebook to automate the process.
